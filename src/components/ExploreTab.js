...
const ExploreTab = ({ viewType, setGameView, longitude, latitude }) => {
    ...
    const submitCoordinate = async () => {
        ...
        const config = await prepareWriteContract({
            ...
            args: [parseInt(longitude.toFixed(4) * 10000), parseInt(latitude.toFixed(4) * 10000)],
        });
                                            ...
                                            return (
                                                <div className={styles.pastGame} key={i}>
                                                    ...
                                                    <div className={styles.pastGameDetails}>
                                                        <div>Longitude: {parseInt(game.winningLongitude) / 10000} </div>
                                                        <div>Latitude: {parseInt(game.winningLatitude) / 10000}</div>
                                                    </div>
                                                </div>
                                            );
                                        })
